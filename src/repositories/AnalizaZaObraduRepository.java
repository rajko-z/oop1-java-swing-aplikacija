...
public class AnalizaZaObraduRepository extends GenericRepository<AnalizaZaObradu> {

	private PosebnaAnalizaRepository analizaRepo;
	private LaborantRepository laborantRepo;
	
	public AnalizaZaObraduRepository(String path, PosebnaAnalizaRepository analizaRepo, LaborantRepository laborantRepo) {
		super(path);
	...
	private Laborant getLaborantFromToken(String token) {
