...
public class FakeLaborantRepository extends GenericRepository<Laborant> {
	private GrupeAnalizaRepository grupeAnalizaRepo;
	private StručnaSpremaRepository stručnaSpremaRepo;
	
	public FakeLaborantRepository(String path, GrupeAnalizaRepository grupeAnalizaRepo, StručnaSpremaRepository stručnaSpremaRepo) {
		super(path);
