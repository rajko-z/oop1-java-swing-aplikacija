...
import repositories.AnalizaZaObraduRepository;
import repositories.GenericRepository;
import repositories.ZahtevRepository;

public class FakeNalazRepository extends GenericRepository<Nalaz>{
	private ZahtevRepository zahtevRepo;
	private AnalizaZaObraduRepository analizaZaObraduRepo;
	
	public FakeNalazRepository(String path, ZahtevRepository zahtevRepo, AnalizaZaObraduRepository analizaZaObraduRepo) {
		super(path); 
	...
	public ArrayList<AnalizaZaObradu> parseAnalizeZaObraduIntoList(String string) {
